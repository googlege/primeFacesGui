...
package de.homedev.primefaces.backend.config;
 ...
 */
@Configuration
@ComponentScan(basePackages = { "de.homedev.primefaces" })
@EntityScan(value = { "de.homedev.primefaces.api.model" })
@EnableJpaRepositories(basePackages = { "de.homedev.primefaces.backend.dao" })
