...
@FacesValidator(value = "adresseValidator")
public class AdresseValidator extends NotNullValidator {
	@Override
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		super.validate(context, component, value);
		String adresse = (String) value;
		if ((adresse != null) && (adresse.length() > AppConstants.FIRSTNAME_MAX_LENGTH)) {
