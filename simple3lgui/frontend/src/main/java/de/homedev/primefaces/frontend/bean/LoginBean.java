...
public class LoginBean implements Serializable {
	...
	public void login(ActionEvent event) throws NamingException, RemoteException {
		...
		IUserFassade userFassade = RmiClientUtil.getUserFassade(1099, "localhost");
	...
	public void toLogout() {
		...
		facesContext.getApplication().getNavigationHandler().handleNavigation(facesContext, null, "/logoutSuccess.jsf?faces-redirect=true");
	}
